package net.theuniverscraft.HgAchievements.Managers;
...
import net.theuniverscraft.HgAchievements.Utils.SqlUtils;
...
public class DbManager {
	...
	public void addAction(Player player, AchievementType type) {
		restorePlayer(player);
